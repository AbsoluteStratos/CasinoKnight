...
> Note: To use new dependencies in the mod, you'll need to edit the [HollowKnightTreasureHunt.csproj](./src/HollowKnightTreasureHunt.csproj) and add a reference to the installed mod in the `<ItemGroup>` section. Search for satchel for an example.
